				...
				<div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-8 mb-24">
					...
					<div className="flex-1 text-center space-y-4">
						...
						<p className={styles.pText}>
							Discover a vast selection of books from all around
							the world.
						</p>
					</div>
					...
					<div className="flex-1 text-center space-y-4">
						...
						<p className={styles.pText}>
							Connect and share your reviews with a community of
							readers worldwide.
						</p>
					</div>
					...
					<div className="flex-1 text-center space-y-4">
						...
						<p className={styles.pText}>
							Create personalized reading lists and keep track of
