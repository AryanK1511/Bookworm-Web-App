...
def get_reading_list():
    try:
            ...
            jsonify(
                {
                    ...
                    "reading_list": reading_list_json,
                }
            ),
            200,
        )
        ...
        return (
            jsonify({"message": "An error occurred while fetching reading list"}),
            500,
        )
...
def remove_book_from_reading_list():
    try:
        ...
        ReadingList.query.filter_by(
            user_id=current_user["id"], google_books_id=google_books_id
        ).delete()
...
def remove_all_books_from_reading_list():
    try:
        ...
        return (
            jsonify({"message": "All books removed from reading list successfully"}),
            200,
        )
...
def check_book_in_reading_list():
    try:
        ...
        book = ReadingList.query.filter_by(
            user_id=current_user["id"], google_books_id=google_books_id
        ).first()
        ...
        return (
            jsonify(
                {
                    "message": "Book exists in reading list",
                    "inReadingList": book is not None,
                }
            ),
            200,
        )
...
def get_book_details(book_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"message": "An error occurred while fetching book and reviews details"}
            ),
            500,
        )
