...
def update_user_profile(user_id):
    ...
    try:
        ...
        return (
            jsonify({"message": "Failed to update user profile", "error": str(e)}),
            500,
        )
...
def login_user():
    ...
    if user and pbkdf2_sha256.verify(password, user.password_hash):
        ...
        return (
            jsonify({"message": "Invalid username or password. Please try again"}),
            400,
        )
...
def register_user():
    ...
    try:
        ...
        return (
            jsonify(
                {"message": "Failed to register user. Server Error.", "error": str(e)}
            ),
            500,
        )
...
def deactivate_user():
    ...
    try:
        ...
        if (
            user_to_be_deleted.profile_picture
            and user_to_be_deleted.profile_picture
